...
try {
    ...
    die("Error: No Exisiting Data for this Student");
}
?>
        ...
        <div class="w-16 h-16 bg-white rounded-full mx-auto mb-2 flex items-center justify-center">
          <img src="photo/logo.png" alt="ST.LUKE LOGO">
            ...
            <div class="sticky bottom-0 bg-blue-600 p-4 mt-auto">
                <a href="logout.php" class="logout-btn block w-full bg-orange-500 hover:bg-orange-600 py-4 rounded-lg text-center flex items-center justify-center gap-4 transition-all font-semibold shadow-lg" title="Logout">
